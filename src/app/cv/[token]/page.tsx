    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      {player.video_url && (
        <a href={player.video_url} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: '#F1EFE8', borderRadius: '8px', textDecoration: 'none', border: '0.5px solid #D3D1C7' }}>
          ...
          <div style={{ flex: 1 }}><div style={{ fontSize: '13px', fontWeight: '700', color: '#0D1B2E' }}>Highlight reel</div><div style={{ fontSize: '11px', color: '#888780' }}>{player.video_url.includes('youtube') ? 'YouTube' : 'Vimeo'}</div></div>
          <div style={{ fontSize: '12px', color: '#1D9E75', fontWeight: '700' }}>Watch →</div>
        </a>
      )}
      {player.video_url_2 && (
        <a href={player.video_url_2} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: '#F1EFE8', borderRadius: '8px', textDecoration: 'none', border: '0.5px solid #D3D1C7' }}>
          ...
          <div style={{ flex: 1 }}><div style={{ fontSize: '13px', fontWeight: '700', color: '#0D1B2E' }}>Match footage</div><div style={{ fontSize: '11px', color: '#888780' }}>{player.video_url_2.includes('youtube') ? 'YouTube' : 'Vimeo'}</div></div>
          <div style={{ fontSize: '12px', color: '#1D9E75', fontWeight: '700' }}>Watch →</div>
        </a>
      )}
      {player.video_url_3 && (
        <a href={player.video_url_3} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: '#F1EFE8', borderRadius: '8px', textDecoration: 'none', border: '0.5px solid #D3D1C7' }}>
          ...
          <div style={{ flex: 1 }}><div style={{ fontSize: '13px', fontWeight: '700', color: '#0D1B2E' }}>Additional footage</div><div style={{ fontSize: '11px', color: '#888780' }}>{player.video_url_3.includes('youtube') ? 'YouTube' : 'Vimeo'}</div></div>
          <div style={{ fontSize: '12px', color: '#1D9E75', fontWeight: '700' }}>Watch →</div>
        </a>
      )}
    </div>
