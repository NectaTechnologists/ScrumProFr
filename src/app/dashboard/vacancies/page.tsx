    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .vac-row-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
      ...
      <nav className="nav">
        ...
        <div className="nav-right">
          <a href="/dashboard/coach-profile" style={{ color: '#D4A843', fontSize: '13px', fontWeight: '700', textDecoration: 'none', whiteSpace: 'nowrap' }}>Coach Card</a>
          <a href="/dashboard/coach" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px', textDecoration: 'none', whiteSpace: 'nowrap' }}>Players</a>
